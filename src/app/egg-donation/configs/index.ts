export const steps = [
  ...
  {
    title: 'Stimulation Cycle & Embryo Creation',
    number: '3',
    descs: [
      'Donor travels with full support from Yunda',
      'Medication begins with monitoring',
      'Egg retrieval under anesthesia',
      'Fertilization + embryo culture in IVF lab',
      'PGT-A testing on Day 5/6 embryos',
      'Results shared in 2–3 weeks',
    ],
    color: '#BFC9BF',
  },
]
